...
describe "User Pages" do
	...
	describe "index" do
		...
		it { should have_content('Список всех пользователей:') }
	...
	describe "signup page" do
		...
		describe "with valid information" do
			before do
				...
				fill_in "Адрес эл. почты:", with: "user@example.com"
	...
	describe "edit" do
		...
		describe "page" do
			it { should have_content("Изменить данные вашего аккаунта:") }
		...
		describe "with valid information" do
			...
			before do
				...
				fill_in "Адрес эл. почты:", with: new_email
